 ...
 before_action :set_sale, only: [:show, :edit, :update, :destroy]
  ...
  def create
    ...
    # #params[:saledetails].each do |item|
       puts "id: " + item.book_id.to_s + ", cantidad: " + item.cantidad.to_s 
    end     
  ...
  private
    ...
    def sale_params
      params.require(:sale).permit(:fechatransaccion, :total, :descuento, :employee_id, :customer_id, :detailsales_attributes => [:book_id , :cantidad , :sale_id]) 
    end
end
